...
import { insertPesanHarianAction } from "../../redux/action";
...
const PesanHarian = () => {
  ...
  const onSubmit = () => {
    if (!form.hari || !form.jam_mulai || !form.jam_selesai || !form.zoom) {
      ...
      dispatch(insertPesanHarianAction(form, navigation));
    }
  };
        ...
        <View style={styles.container}>
          <View>
            ...
            <Pressable onPress={toggleHariPicker} style={styles.pickerContainer}>
              <Text style={styles.pickerText}>{form.hari || "Pilih hari"}</Text>
            </Pressable>
            {showHariPicker && (
              <Picker
          ...
          <View>
            ...
            <Pressable onPress={toggleZoomPicker} style={styles.pickerContainer}>
              <Text style={styles.pickerText}>{form.zoom || "Pilih User Zoom"}</Text>
            </Pressable>
            {showZoomPicker && (
              <Picker
